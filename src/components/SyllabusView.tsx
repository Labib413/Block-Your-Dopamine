                            ...
                            <div key={res.id} className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.03] border border-white/5 group hover:bg-white/5 transition-colors">
                              <div className="flex items-center gap-4 overflow-hidden">
                                ...
                                <div className="overflow-hidden">
                                  ...
                                  <a href={isValidUrl(res.url) ? res.url : '#'} target="_blank" rel="noopener noreferrer" className="text-[10px] text-white/30 truncate flex items-center gap-1 hover:text-neon-green transition-colors">
                                    {res.url}
