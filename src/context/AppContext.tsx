...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PERFORMANCE: Use a Map for O(1) lookups during subject progress calculation
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // PERFORMANCE: Use Maps for O(1) lookups during chapter merge to avoid O(N^2) complexity
