...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PRIMARY FIX: Use a Map for O(1) lookups and prevent "ghost" data from duplicates
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // O(1) Lookup Optimization: Create Maps for merging
          const cloudMap = new Map<string, any>();
          cloudChapters.forEach((c: any) => cloudMap.set(c.id, c));
