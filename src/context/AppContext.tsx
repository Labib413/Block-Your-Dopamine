...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PERFORMANCE OPTIMIZATION: Using Map for O(1) lookups in the nested loop below
  ...
  const updatedSubjects = subjects.map(s => {
    ...
    // PERFORMANCE: Optimized with Map-based lookup (O(1)) instead of array search (O(N))
