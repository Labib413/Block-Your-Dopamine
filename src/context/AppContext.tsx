...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // OPTIMIZATION: Use Map for O(1) lookups and build it efficiently using for...of to avoid intermediate arrays.
  // This also handles deduplication (last one wins) as required to prevent "ghost" data.
