...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PRIMARY FIX: Use Map for O(1) lookups and filter out any duplicate chapter IDs
  const uniqueChaptersMap = new Map<string, AcademicChapter>();
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // Optimization: Use Maps for O(1) lookups during merge
