...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PERFORMANCE: Use a Map for O(1) lookups instead of repeated O(N) array searches
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // PERFORMANCE: Use Maps for O(1) lookups during merging to avoid O(N^2) complexity
