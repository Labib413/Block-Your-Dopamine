...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PERFORMANCE OPTIMIZATION: Use a Map for O(1) lookup instead of O(N^2) linear search
  // Filter out any duplicate chapter IDs to prevent "ghost" data
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // PERFORMANCE OPTIMIZATION: Use Maps for O(1) lookup during merge to avoid O(N^2)
