...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // ⚡ Bolt Optimization: Use Map for O(1) lookups instead of O(N) .find()
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // ⚡ Bolt Optimization: Use Map for O(1) lookups during chapter merge
          ...
          const mergedChapters = defaultChapters.map(defaultCh => {
            ...
            if (localTimestamp > cloudTimestamp) return (localCh as AcademicChapter) || defaultCh;
            if (cloudCh) return {
            ...
            return (localCh as AcademicChapter) || defaultCh;
          });
