...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // BOLT OPTIMIZATION: Use a Map for O(1) lookups instead of O(N) array searches.
  // This reduces complexity from O(S * C * N) to O(N + S * C), where S=subjects, C=chapters/subject, N=total chapters.
