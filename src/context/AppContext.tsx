...
const calculateAllSubjectsProgress = (chapters: AcademicChapter[], userId: string | null) => {
  ...
  // PRIMARY FIX: Use a Map for O(1) lookups and to filter out any duplicate chapter IDs to prevent "ghost" data
    ...
    try {
      ...
      setState(prev => {
        ...
        if (results.academicChapters?.data) {
          ...
          // BOLT OPTIMIZATION: Convert arrays to Maps for O(1) lookups during merge
